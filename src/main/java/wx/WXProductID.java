...
public class WXProductID {
	...
	//测试
//	static String access_toket_url = "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=wx15692e8dccaef0a1&secret=5515a0ec4559e1d8222f05b8fcf05d09";
	//正式
	...
	static String token = "qAj4q0aQx-p9w9X6O_a8JnTjhy9Oe2MLGFdgNMpD661fBawMXlwe88TB8-DBkv418m8vM30D457DV7fL1GQVGKzPv47xWaxXLgHlFDgYi4pa7luzi_HECLdp0FsQRqc-IRNhABAENJ";
	...
	public void getQrcode() {
		String url = "https://api.weixin.qq.com/device/getqrcode?access_token=%s&product_id=22571";
		String tempUrl = String.format(url, token);
		doGet(tempUrl);
	...
	public void authDev() {
		...
		JSONObject jsonObject = new JSONObject();
		jsonObject.put("id", "gh_f279452b86ad_a51d82ae01dca885");
		jsonObject.put("mac", "5CCF7Fd0BD2E");
